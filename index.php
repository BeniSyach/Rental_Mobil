...
<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 				
			<li class="sig"><a href="#" data-toggle="modal" data-target="#myModal" >Halo <?php echo"$_SESSION[name]";?></a></li> 
					...
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<!-- <li><a href="privacy.php">Privasi</a></li> -->
								...
								<li><a href="jual.php">Jual Beli Mobil</a></li>
								<div class="clearfix"></div>
						</ul>
					</nav>
				</div><!-- /.navbar-collapse -->	
...
<div class="banner">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn; color: black;"> Rental Mobil Dan Jual Mobil Murah</h1>
	</div>
</div>
<div class="container">
	...
	<div class="col-md-7 bann-info wow fadeInRight animated" data-wow-delay=".5s">
		<h2 style="background: #EAEAEA; text-align: center; padding: 5px;">Rental Mobil Online dengan Harga yang tidak terjangkau</h2>
		<div class="ban-top">
			<div class="bnr-left">
...
<div class="copy-right">
	<div class="container">
		...
		<p class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">© 2019 Rental Mobil kelompok wkwkwk. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">ASU</a> </p>
	</div>
</div>
<!--- /copy-right ---->
<!-- sign -->
